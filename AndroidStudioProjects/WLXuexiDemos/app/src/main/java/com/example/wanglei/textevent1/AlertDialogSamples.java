...
/**
 * Created by wanglei on 15/12/23.
 */
                ...
                return new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Log.v(TAG,"******/* User clicked OK so do some stuff */");
                            }
                        })
                        .setNegativeButton(R.string.alert_dialog_cancel, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Log.v(TAG,"******/* User clicked cancle so do some stuff */");
                                    }
                                }
                        )
                        .create();
...
//        progressSpinnerButton.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
...
//        twoButtonsDefaultLightTitle.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
...
//        twoButtonsDefaultDarkTitle.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
